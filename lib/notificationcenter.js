(function(root, factory) {
  if (typeof exports === 'object') {
    // Node.js
    factory(exports, module, require('./notification'));
  } else if (typeof define === 'function' && define.amd) {
    // AMD
    define(['exports', 'module', './notification'], factory);
  }
}(this, function(exports, module, Notification) {
   ...
   * @api public
   */
  NotificationCenter.prototype.removeObserver =
  NotificationCenter.prototype.off = function(name, sender, fn) {
    if (typeof sender == 'function') { fn = sender, sender = null; }
    if (typeof name == 'object' && name) { sender = name, name = null; }
    if (typeof name == 'function') { fn = name, sender = null, name = null; }
